...
public class RemoveLocalVarDialog extends QDialog
{
	private QComboBox var_list;
	private FsmModule module;
	
	public RemoveLocalVarDialog(FsmModule module)
	{
		this.module = module;
		createComboBox();
		createLayout();
	...
	{
		setWindowTitle("Remove local variable");
		
		QGridLayout grid = new QGridLayout();
		
		grid.addWidget(new QLabel("Variable to remove: "), 0, 0);
	...
	protected void okClicked()
	{
		...
		LocalVariable lv = module.getLocal_variables().remove(index);
		lv.removed.emit();
